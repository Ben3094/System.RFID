...
namespace System.RFID.UHFEPC
{
    public partial class GS1Tag : Tag
    {
        ...
        public GS1Tag(byte[] uid) : base(uid)
        {
            ...
            //TODO: Clean this
            ushort firstPart = (ushort)(uid[DESIGNER_IDENTIFIER_BYTE_INDEX] << DESIGNER_IDENTIFIER_BYTE_SHIFT);
            byte secondPart = (byte)(uid[DESIGNER_IDENTIFIER_BYTE_INDEX + 1] >> (8 - DESIGNER_IDENTIFIER_BYTE_SHIFT));
            this.DesignedIdentifier = (ushort)(((firstPart << 8) | secondPart) & DESIGNER_IDENTIFIER_MAX_VALUE);
            
            firstPart = (ushort)(uid[MODEL_IDENTIFIER_BYTE_INDEX] << MODEL_IDENTIFIER_BYTE_SHIFT);
        ...
        public const byte EXTENDED_TID_BYTE_SHIFT = 7 - (EXTENDED_TID_INDEX % 8);
        ...
        public const byte DESIGNER_IDENTIFIER_BYTE_SHIFT = 7 - (DESIGNER_IDENTIFIER_START_INDEX % 8);
        ...
        public const int MODEL_IDENTIFIER_BYTE_SHIFT = 12 - (MODEL_IDENTIFIER_START_INDEX % 8);
